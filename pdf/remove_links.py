...
MATCHES = {
    ...
    '<strong>Generators and iterators are interchangeable (see <a href="#iterator-1">Iterator</a> duck type).</strong>' :'<strong>Generators and iterators are interchangeable (see p. 17 for details).</strong>',
    ...
    '<strong>See module <a href="#operator">operator</a> to get names of all special methods that are called by operators.</strong>': '<strong>See Operator (p. 30) to get names of all special methods that are called by operators.</strong>',
